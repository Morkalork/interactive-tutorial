...
export const prepareStep = (option, generalOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const text = option.text
        ? createText(boundaries, option.text, option.textOffsetX || generalOptions.textOffsetX || 0, option.textOffsetY || generalOptions.textOffsetY || 0, option.preferredPosition)
        : undefined;
